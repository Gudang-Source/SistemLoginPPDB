  ...
  <body>
    ...
    <div class="sidebar shadow-lg pt-3 position-fixed bg-light">
      <ul class="nav flex-column nav-pills p-3">
        ...
        <li class="nav-item mb-1">
          <a class="nav-link active" href="#" title="Tambah Siswa"><i class="fas fa-plus"></i><span> Tambah Siswa</span></a>
        </li>
        <li class="nav-item mb-1">
      ...
      <div class="container p-5 pt-5 position-relative">
        ...
        <form class="p-4" action="" method="post">
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="namalengkap" placeholder="Nama Lengkap" name="nama" required autofocus>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="sekolahasal" placeholder="sekolah asal" name="sekolahasal" required>
              </div>
            <div class="form-group">
