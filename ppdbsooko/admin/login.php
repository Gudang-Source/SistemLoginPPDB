...
if (isset($_COOKIE['id'])&&isset($_COOKIE['key'])) {
	...
	$result = mysqli_query($conn, "SELECT email FROM useradmin WHERE id = $id");
    ...
    <div class="gate mt-3">
      <form class="form-gate p-4" action="" method="post">
        <div class="text-center">
          ...
          <h2 class="mt-2 font-weight-normal">Login Admin</h2>
          <?php if(isset($error)): ?>
        ...
        <div class="custom-control custom-checkbox">
          ...
          <label class="custom-control-label" for="customCheck1" name="remember">Remember me</label>
        </div>
        <button type="submit" class="btn btn-block btn-primary mt-3" name="login">Sign in</button>
        <p class="text-center mt-5 text-muted small">Copyright &copy; 2020 | <a href="#" class="text-decoration-none">M. Auliya Mirzaq Romdloni</a></p>
      </form>
    </div>
